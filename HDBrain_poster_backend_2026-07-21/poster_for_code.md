...
window.FIGURES = {
  ...
  scenarios: [
    ...
    { income: 5000, price: 440850, count: 314, pct: 20.5 },
    { income: 8000, price: 705359, count: 795, pct: 51.8, median: true },
    { income: 12000, price: 1058039, count: 1366, pct: 89.0 },
    { income: 15000, price: 1322549, count: 1497, pct: 97.6 },
...
|---|---|---|---|
| 2026-07-21 | **Affordability 引擎重跑**：`src/run_affordability.py` 基于新 XGBoost 模型重新计算 scenarios | `scenarios[]`（`count`、`pct`）、`n_profiles` | `run_pipeline.py` 未包含 affordability 阶段，旧 scenarios 基于旧模型；新 CPI 下预测价格上升，可负担组合数减少 |
